...
int main (int argc, char** argv)
{
    ...
    std::string dataPath = "../data/" + dataName;
    ...
    if (recordBackground){
        ...
        std::string backgroundDataPath = "../data/background";
        ...
        std::string outputPath = "../data/background.pcd";
    ...
    bgCloud = cloudIO->loadPcd("../data/background.pcd");
